...
public class RubyGenerator extends JsonGeneratorBase {
    ...
    // NEED MIGRATION
    private final static byte[] NULL_BYTES = { 'n', 'i', 'l' };
    // NEED MIGRATION
    ...
    public RubyGenerator(IOContext ctxt, int features, ObjectCodec codec, OutputStream out) {
    ...
    public RubyGenerator(IOContext ctxt, int features, ObjectCodec codec, OutputStream out, byte[] outputBuffer, int outputOffset, boolean bufferRecyclable) {
	...
	//_outputTail += 4;
	System.arraycopy(NULL_BYTES, 0, _outputBuffer, _outputTail, 3);
	_outputTail += 3;
    }
