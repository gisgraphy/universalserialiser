 ...
 */
public class PythonSerializer extends AbstractSerializer {

	private static Pattern p = Pattern.compile("\\w+");

	private static final Logger logger = Logger.getLogger(PythonSerializer.class);
	...
	public PythonSerializer() {
		mapper = new ObjectMapper(new PythonFactory());
	...
	public <T> T read(InputStream inputStream, Class<T> classToBeBound) throws SerializerException {
		throw new RuntimeException("read is not implemented for Python");
	}
