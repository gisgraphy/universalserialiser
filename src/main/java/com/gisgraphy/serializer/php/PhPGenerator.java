...
public class PhPGenerator extends JsonGeneratorBase {
  ...
  //NEED MIGRATION
	//ADD
	private final static byte[] ARRAY_BYTES = { 'a', 'r', 'r', 'a', 'y', '(' };
    ...
    public PhPGenerator(IOContext ctxt, int features, ObjectCodec codec, OutputStream out) {
    ...
    public PhPGenerator(IOContext ctxt, int features, ObjectCodec codec, OutputStream out, byte[] outputBuffer, int outputOffset, boolean bufferRecyclable) {
	...
	if (_cfgPrettyPrinter != null) {
		...
		_flushBuffer();
	    	...
	    	//NEED MIGRATION
		//REMOVE _outputBuffer[_outputTail++] = BYTE_LBRACKET;
		//ADD
		System.arraycopy(ARRAY_BYTES, 0, _outputBuffer, _outputTail, 6);
		_outputTail += 6;
		//END ADD
	}
    }
	...
	if (_cfgPrettyPrinter != null) {
	  ...
	  //NEED MIGRATION
		//REMOVE _outputBuffer[_outputTail++] = BYTE_RBRACKET;
		//ADD
	...
	if (_cfgPrettyPrinter != null) {
	  ...
	  //NEED MIGRATION
		//REMOVE _outputBuffer[_outputTail++] = BYTE_LCURLY;
		//ADD
		System.arraycopy(ARRAY_BYTES, 0, _outputBuffer, _outputTail, 6);
		_outputTail += 6;
		//END ADD
	...
	if (_cfgPrettyPrinter != null) {
	  ...
	  //NEED MIGRATION
		//ADD _outputBuffer[_outputTail++] = BYTE_RCURLY;
		_outputBuffer[_outputTail++] = ')';
	}
    }
	...
	if (_cfgPrettyPrinter == null) {
		...
		// NEED MIGRATION
		// MODIFY _outputBuffer[_outputTail] = b;
